...
#   - prepend all log messages to file: csv_prepend_example.csv at current
#        working directory
#   - prepended log message must be on a top of file (or position = 0)

set log [::logger::init logConsole]

setConfigOption filename "csv_prepend_example.csv"
